      ...
      <section className='instructor mb-16'>
        <div className='container'>
          <div className='heading py-12 text-center w-2/3 m-auto md:w-full'>
            <h1 className='text-3xl font-semibold text-black'>Reconnect. Inspire. Make an Impact.</h1>
            <span className='text-[14px] mt-2 block'>You’ve walked the halls, faced the challenges, and carved your path beyond college. Now it’s time to give back, reconnect, and be part of something bigger. Twin Alumina is your space to stay connected with your alma mater and empower the next generation of students.</span>
          </div>
          <div className='content grid grid-cols-2 gap-5 md:grid-cols-1'>
            ...
            <div className='images rounded-lg relative overflow-hidden h-72 w-ful before:bg-backbg before:h-72 before:w-full before:absolute before:top-0 before:left-0 before:content before:z-10'>
              ...
              <div className='categ flex flex-col gap-4 absolute top-5 z-30 m-3 p-8 items-center justify-center text-center'>
                <h2 className='text-3xl text-white font-semibold'>Become an Part Of The Family</h2>
          ...
          <div className='content'>
            <div className='heading py-12 text-center w-2/3 m-auto md:w-full'>
              <h1 className='text-3xl font-semibold text-black'> Why Join the Alumni Network</h1>
            ...
            <div className='content grid grid-cols-4 gap-5 md:grid-cols-2'>
              <InstructorCard color='text-red-500' icon={<FaUsers size={40} />} title='6300' desc='Students Graduated' />
              <InstructorCard color='text-orange-500' icon={<GiEvilBook size={40} />} title='60+' desc='Total Courses' />
              <InstructorCard color='text-purple-500' icon={<FaGraduationCap size={40} />} title='400' desc='Online Learners' />
              <InstructorCard color='text-indigo-500' icon={<GiWorld size={40} />} title='40' desc='Students Across Globe' />
            </div>
          </div>
        </div>
      </section>
